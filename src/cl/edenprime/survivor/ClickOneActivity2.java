...
public class ClickOneActivity2 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent.putExtra("SUBJECT", obtenerPosRamoPorId(dataS.getActividadesCercanas().get(1).getIdRamo()));
		intent.putExtra("EDIT", obtenerPosActividadPorId(dataS.getActividadesCercanas().get(1).getId()));
