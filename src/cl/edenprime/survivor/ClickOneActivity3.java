...
public class ClickOneActivity3 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent.putExtra("SUBJECT", obtenerPosRamoPorId(dataS.getActividadesCercanas().get(2).getIdRamo()));
		intent.putExtra("EDIT", obtenerPosActividadPorId(dataS.getActividadesCercanas().get(2).getId()));
