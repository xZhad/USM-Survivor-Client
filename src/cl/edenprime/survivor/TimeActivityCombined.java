...
public class TimeActivityCombined extends Activity {
	...
	public void setHorario() {
		for (int i = 0; i < dataS.getClases().size(); i ++) {
			...
			click.setBackgroundResource(R.drawable.roundcontainerazul);
	...
	public void setHorarioEX() {
		for (int i = 0; i < horarioRecibido.size(); i ++) {
			...
			click.setBackgroundResource(R.drawable.roundcontainerverde);
